...
| Express | [`req.auth`](/docs/backend-requests/session-requests/handling/nodejs) |
...
<Properties>
  ...
  The current user's [session claims](/docs/backend-requests/session-requests/session-tokens#default-session-claims).
  ...
  A function that gets the current user's [session token](/docs/backend-requests/session-requests/session-tokens) or a [custom JWT template](/docs/backend-requests/session-requests/making/jwt-templates).
...
`getToken()` retrieves the current user's [session token](/docs/backend-requests/session-requests/session-tokens) or a [custom JWT template](/docs/backend-requests/session-requests/making/jwt-templates).
